...
public abstract class SpiceColorStopGradientFillingBuilder<C extends Color, T extends ColorStopGradientFilling<C>> implements ColorStopGradientFilling.IBuilder<C, T> {
