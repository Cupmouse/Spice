...
//        IntStream.range(0, 60).forEach(i -> ir = rgbaImageBlender.blendData(Pair.of(i1.getData(), 1000), Pair.of(i3.getData(), 1000)));
        ir = rgbaImageBlender.blendImage(Pair.of(i1.getData(), 500), Pair.of(i3.getData(), 1000));
        ...
        frame.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getButton() == 3) {
                    ir = rgbaImageBlender.blendImage(Pair.of(i1.getData(), e.getX()), Pair.of(i3.getData(), 1000));
